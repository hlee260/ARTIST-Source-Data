...
datafile = pd.read_excel('Figure2i.xlsx')
time = datafile['Time']
data = datafile.loc[:, '0 nM':'100 nM']
time = time - time[0]

plt.plot(time, data['0 nM'],  color=[0,0,0.2],linewidth=lw)
plt.plot(time, data['1 nM'], color=[0,0,0.5], linewidth=lw)
plt.plot(time, data['3 nM'],  color=[0,0,0.8], linewidth=lw)
plt.plot(time, data['5 nM'], color=[0,0,1], linewidth=lw)
plt.plot(time, data['10 nM'], color=[0,0.4,1], linewidth=lw)
plt.plot(time, data['100 nM'], color=[0,0.6,1], linewidth=lw)
