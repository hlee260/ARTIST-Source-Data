...
datafile = pd.read_excel('Figure2h_EPM.xlsx')
concentrations = datafile['IFN']
EPM = datafile.loc[:, 'Figure2h_EPM']
plt.plot(concentrations, EPM['Figure2h_EPM'], 'o', linewidth = 4, markersize = 10, color = 'blue', label = 'Experiment')
